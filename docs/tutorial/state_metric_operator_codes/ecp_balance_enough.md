# ecp_balance_enough 计算代码

- `operatorType`: `metric`
- `operatorNameEn`: `ecp_balance_enough`
- `operatorNameCn`: `账户余额是否充足`
- `groupName`: `ecp`
- DF 来源：`/Users/bytedance/develop/dataset_factory/tool_handlers/query_metrics/ecp.py:114`
- DF handler：`ecp_balance_enough`
