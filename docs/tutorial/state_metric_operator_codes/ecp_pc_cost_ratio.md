# ecp_pc_cost_ratio 计算代码

- `operatorType`: `metric`
- `operatorNameEn`: `ecp_pc_cost_ratio`
- `operatorNameCn`: `千川PC消耗占比`
- `groupName`: `ecp`
- DF 来源：`/Users/bytedance/develop/dataset_factory/tool_handlers/query_metrics/ecp.py:61`
- DF handler：`ecp_pc_cost_ratio`
